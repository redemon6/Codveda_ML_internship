...
• Predict continuous values using LinearRegression
...
• Classify binary labels using LogisticRegression
✅ Task 2	Decision Trees for Classification
• Build decision trees and visualize them
...
• Use SVM for classification tasks
✅ Task 3	Neural Networks with TensorFlow/Keras
• Train and evaluate neural networks on real-world data
📂 Directory Structure
Codveda-ML-Internship/
│
├── Level_1/
